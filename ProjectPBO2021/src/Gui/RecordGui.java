...
public class RecordGui {
    ...
    public RecordGui(){
        ...
        JLabel label_provinsi = new JLabel("Provinsi");
        label_provinsi.setBounds(30,100,100,30);
        frame_record.add(label_provinsi);
        ...
        update.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                try{
                    ...
                    int potensiPenularan = Integer.parseInt(textPotensiPenularan.getText());
                    int i = tabelRecord.getSelectedRow();
                    AllObjectController.recordcontroller.UpdateRedord(i,provinsi, tingkatKematian, jumlahKasus, potensiPenularan);
                    tabelRecord.setModel(viewTabelBarang());
                    refreshText();
                }catch(Exception e){
                    JOptionPane.showMessageDialog(null, "Format ada yang salah", "information", JOptionPane.INFORMATION_MESSAGE);
